...
<div class="container-fluid">
  ...
  @if($pegawai->riwayatjabatanf->count() !== 0)
        ...
        <form action="/pegawai/jabatanfungsional/edit/{{$jabatanf->id_jabatanf}}" method="post">
        {{ csrf_field()}}
  ...
  <input type="text" class="form-control" value="{{$pegawai->nama}}" disabled>
        ...
        <div class="col-md-6">
        <label>No. SK</label>
        <input type="text" name="no_sk" class="form-control" value="{{$jabatanf->no_sk}}">
        </div>
        ...
        <input type="date" name="tgl_sk" class="form-control" value="{{$jabatanf->tgl_sk}}">
        </div>

        <div class="col-md-6">
        <label>Pejabat Pengesah</label>
        <input type="text" name="pejabat_sk" class="form-control" value="{{$jabatanf->pejabat_sk}}">
        </div>
        ...
        <input type="date" name="tmt" class="form-control" value="{{$jabatanf->tmt}}">
        </div>
        </div>
        ...
        <input type="text" name="ket" class="form-control" value="{{$jabatanf->ket}}">
        </div>
        </div>
        <div class="row m-3">
